...
function loadNav() {
	...
	title.add( Ti.UI.createLabel({ text: 'new ' + cacheData.type, font: { fontSize: Alloy.CFG.size_20, fontFamily: Alloy.CFG.font_DroidSans }, color: '#fff', left: Alloy.CFG.size_50 }) );
